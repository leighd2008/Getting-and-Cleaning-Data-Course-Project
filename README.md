...
The Get_Samsung_Data.R file will retrieve the "Human Activity Recognition Using Smartphones Dataset Version 1.0) and extract the Dataset along with the codebook and readme files into a "UCI HAR Dataset" folder in the working directory. The corresponding Readme file has been copied below describing the study design, data collection and initial processing.
